    ...
    def state(self):
        ...
        if (self.isBitalino2):
            if (self.started == False):
                ...
                decodedData = list(struct.unpack(16*"B ", Data[0:16]))
                ...
                if crc == x & 0x0F:
                    ...
                    if not self.wifi:
                        ...
                        status_data = str(Data).encode('hex')
                        status_data = status_data[-4:]
                        if status_data.decode('hex') == '\r\n':  # BITalino on steroids
                            return acquiredData
                        else:  # CloudBIT
                            ...
                            acquiredData['mode'] = cb_mode
                            acquiredData['samplingRate'] = cb_sampling_rate
                            acquiredData['selectedChannels'] = cb_channels
                            return acquiredData
                else:
